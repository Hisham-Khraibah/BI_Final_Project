...
def get_budget_path() -> str:
    '''Return the budget settings file path as a string.'''
    return str(BUDGET_PATH)

def get_custom_cat_path() -> str:
    '''Return the custom categories file path as a string.'''
    return str(CUSTOM_CAT_PATH)

def get_custom_keyword_path() -> str:
    '''Return the custom keyword rules file path as a string.'''
